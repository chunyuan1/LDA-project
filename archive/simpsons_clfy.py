...
import pandas as pd
data = pd.read_csv('../data/simpsons_proc_2.csv')

data = data[data['word_count'] >= 25]
dim = 20

#%% 1.1 Choose Characters
...
trainX = dataTrain['normalized_text']
trainY = dataTrain['character_id']
testX = dataTest['normalized_text']
testY = dataTest['character_id']
